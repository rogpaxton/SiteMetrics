...
#    m.create_map(path='map.html')
    ...
    iframe_html=folium.element.Html("""
        <iframe name="ifrm" id="ifrm2" src="plot44.0.png" scrolling="no" allowtransparency="true" ></iframe>
...
#                    <img id="RC51" src="RC51.jpg" alt="RVT" style="width:48px;height:49px;">
    ...
    iframe = folium.element.IFrame(html=iframe_html, width=800, height=400)
#    iframe = folium.element.HTML(html=html, width=800, height=500)
    popup = folium.Popup(iframe, max_width=2650)
    popup = folium.Popup(<img src="plot44.0.png" style="width:400px;height:200px;">)

    icon = folium.features.CustomIcon('plot44.0.png')
